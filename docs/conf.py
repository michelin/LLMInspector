...
# Default docstring format is RST, you can add extensions
# "sphinx.ext.ifconfig", "sphinx.ext.napoleon" to support Google / numpy dostring format
...
#
# If you want the theme readthedocs uncomment the follow line and
# add sphinx_rtd_theme wheel to your dependencies
...
# If you want to include your README.md, you have to
# - Add recommonmark to your dependencies and in your sphinx extensions
# - Add "md" to source_suffix
# - And uses the followed code:
# import shutil
# readme = os.path.join(project_directory, "README.md")
# if os.path.isfile(readme):
#     shutil.copyfile(readme, os.path.join(current_directory, "README.md"))
